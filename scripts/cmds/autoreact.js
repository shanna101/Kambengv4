module.exports = {
  ...
  onChat: async function ({ event, api }) {
    ...
    const reactionsMap = {
      ...
      "❤": ["hi", "hey", "hello", "yo", "sup", "zup", "halo", "henlo", "love", "mahal", "salamat", "thank", "ty", "tnx", "thx", "thnx", "yup", "crush", "sarap", "ugh", "pogi", "iyot", "kantot", "kiss", "ganda", "babe", "baby", "darling", "labyu", "eve", "morning", "good", "aft", "❤", "🥰", "😘", "😍", "🤩", "gm", "gn", "mwa", "mwua", "mwhehe", "nice", "mahusay", "galing", "miss", "bot", "Gojo", "Gab", "pusa"],
